...
<head>
    ...
    <title>COVID-19 | Local distribution</title>
    <!-- google font -->
                ...
                <div class="page-content">
                    ...
                    <div class="col-lg-6 p-t-20"> 
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                            <label for="simpleFormEmail">Select City</label>
                    ...
                    <FORM NAME="formState" METHOD="POST">
                        ...
                        <button type="button" class="btn btn-round btn-primary" style="width: 45%;margin-left: 30px;" onclick="selectState()">Select</button><br>
                    </FORM><br><br>
                    <script>
                        function selectState(){
                            var x = $('#sel').val();
                            window.location.href='./dist_city.jsp?cid='+x;
                        }
                    </script>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="overview-panel deepPink-bgcolor">
                                    ...
                                    <div class="value white">
                                        ...
                                        <button type="button" class="btn btn-round btn-danger" id="distrubutenow" onclick="changeTotalNo()" style="">Distribute</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="col-md-12">
                            <div class="card card-topline-aqua">
                                ...
                                <FORM NAME="form1" METHOD="POST">
                                    ...
                                    <button type="button" class="btn btn-round btn-primary" style="width:40%;margin-left:30%;margin-bottom: 20px;" onclick="sendVaccine()">Send Vaccine</button><br>
                                </FORM>
                                <% 
