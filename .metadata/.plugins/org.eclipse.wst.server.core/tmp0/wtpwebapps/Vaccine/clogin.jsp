...
<head>
    ...
    <title>COVID-19 |City Login</title>
    <!-- google font -->
                                ...
                                <div class="user-panel">
                                    <div class="row">
                                        ...
                                        <div class="profile-usertitle">
                                            <div class="sidebar-userpic-name">City Name </div>
                                            <div class="profile-usertitle-job"> City </div>
                                        </div>
                                </div>
                            </li>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">City Login</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">City Login</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                     ...
                     <div class="row">
						<div class="col-sm-6">
							...
							<form method="post" action="clogindb.jsp">
