<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 if(session.getAttribute("username") == null) {
	...
	try
	{
	    ...
	    while(rss.next()){
            total_vc=rss.getInt("no_of_vaccine");
%>
...
<head>
    ...
    <title>COVID-19 | State distribution</title>
    <!-- google font -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="overview-panel deepPink-bgcolor">
                                    ...
                                    <div class="value white">
                                        <p>Distribute Avaliable Vaccine</p>
                                    ...
                                    <table id="example4" class="display full-width">
                                        ...
                                        <%
                                            try
                                            {
                                                ...
                                                String sqlfinal="select sum(cp),sum(cw),sum(op) from state"; 
                                    ...
                                    if(request.getParameter("buttonName") != null) {
                                        ...
                                        try
                                        {
                                            ...
                                            while(rs.next()){
                                                ...
                                                String sqls="update state set total_vaccine='"+totalvacciness+"',allocated_vaccine='"+vis+"' where id='"+id+"'";
                                                stmt1.executeUpdate(sqls);
                                            }

                                            String sqls="update vaccine set no_of_vaccine='"+tominus+"'";
                                            stmt1.executeUpdate(sqls);
                                            response.sendRedirect("./dist_vaccine.jsp?id=1");
                                        }
                                        catch(Exception e)
                                        {
                                            System.out.print(e);
