...
<head>
    ...
    <title>COVID-19 |Hospital Login</title>
    <!-- google font -->
                                ...
                                <div class="user-panel">
                                    <div class="row">
                                        ...
                                        <div class="profile-usertitle">
                                            <div class="sidebar-userpic-name">Hospital Name </div>
                                            <div class="profile-usertitle-job"> Hospital </div>
                                        </div>
                                </div>
                            </li>
                            <li class="nav-item start">
                                <a href="login.jsp" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                                    <span class="title">Admin Login</span>
                                </a>
                            </li>
                            <li class="nav-item start">
                                <a href="slogin.jsp" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                                    <span class="title">State Login</span>
                                </a>
                            </li>
                             <li class="nav-item start">
                                <a href="clogin.jsp" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                                    <span class="title">City Login</span>
                                </a>
                            </li>
                            <li class="nav-item start">
                                <a href="hlogin.jsp" class="nav-link nav-toggle">
                                    <i class="material-icons">dashboard</i>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Hospital Login</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Hospital Login</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Fill  Details</li>
                            </ol>
                        </div>
                    </div>
                     <div class="row">
						<div class="col-sm-6">
							...
							<form method="post" action="hlogindb.jsp">
								<div class="card-body row">
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input class = "mdl-textfield__input" type = "text" name="name">
                                         <label class = "mdl-textfield__label">Enter Userame</label>
                                      </div>
                                    </div></div>
                                    <div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         ...
                                         <label class = "mdl-textfield__label">Enter Password</label>
                                      </div>
						           	</div>
