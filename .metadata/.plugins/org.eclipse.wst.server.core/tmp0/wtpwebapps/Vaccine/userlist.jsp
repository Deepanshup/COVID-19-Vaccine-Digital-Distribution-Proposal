<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%
	  try
	  {
	    ...
	    String sqll ="select * from hospital where name='"+username+"'";
	    ResultSet rss= stmt1.executeQuery(sqll);
	    while(rss.next()){
	       String av=rss.getString("allocated_vaccine");
	       String wn2=rss.getString("ward");
%>
 <%
	  try
	  {
	    ...
	    String sqlll ="select count(*) from user where status=1 and ward_no='"+wn2+"'";
	    ResultSet rss1= stmt2.executeQuery(sqlll);
	    while(rss1.next()){  
%>
<!DOCTYPE html>
<html lang="en">
							...
							<div class="col-lg-4 col-sm-6">
								<div class="overview-panel purple">
									...
									<div class="value white">
										...
										<%out.println(rss.getString("allocated_vaccine"));%>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-topline-aqua">
                                <div class="card-head">
                                    <header>USER LEFT FOR VACCINATION</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                  <div class="table-scrollable">
                                    <table id="example4" class="display full-width">
                                        ...
                                        <%
	                                        ...
	                                        try
	                                        {
	                                        	...
	                                        	String sql ="select * from user where status=0 and ward_no='"+wn1+"'";
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="label label-sm label-danger">Not Vaccinated</span></td>
                                                <td>
	                                                <FORM NAME="form1" METHOD="POST" action="sendmail.jsp">
					                                    <INPUT TYPE="HIDDEN" NAME="useremail" value="<%= rs.getString("email") %>">
					                       				<button class="label label-sm label-failure" style="border:none;">Send Mail</span>            
					                                </FORM>
				                                </td>
                                    ...
                                    function sendmail()
                                    {
                                        var recmail=document.getElementById("d1");
                                        form1.submit();
                                    } 
                                </SCRIPT>
                                    </div>
                                    ...
                                    <table id="example1" class="display full-width">
                                        ...
                                        String wn=rss.getString("ward");
                                            try
                                            {
                                                ...
                                                "jdbc:mysql://localhost:3306/covid","root","");  
                                                Statement stmt=con.createStatement();  
                                                String sql ="select * from user where status=1 and ward_no='"+wn+"'";
                                                ResultSet rs= stmt.executeQuery(sql);
                                                while(rs.next()){
                                            %>
                                            <tr>
                                                ...
                                                <td><%= rs.getString("phone") %></td>
                                                <td><%= rs.getString("email") %></td>
                                                <td><span class="label label-sm label-success">Vaccinated</span></td>
                                            </tr>
                                            <%
                                                }
